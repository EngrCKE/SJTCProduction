/***********************
 * SJTC Production Department Dashboard v1.2.7
...
const demo = (() => {
  ...
  return {
    settings: { ADMIN_PIN: DEMO_PIN, APP_NAME: "SJTC Production Department Dashboard", VERSION: "1.2.7", PROCESS_COLUMNS: DEFAULT_PROCESS_COLUMNS.join("|") },
    personnel,
    ...
    <div class="settingsForm compactSettingsForm">
      ...
      <div class="memberPickerBlock">
        ...
        <div class="memberPickerList groupedMemberPicker">
          ${groupByDepartment(activePersonnelSorted()).map(g=>`<details class="deptPickGroup"><summary>${escapeHtml(g.dept)} <span class="badge">${g.items.length}</span></summary>${g.items.map(p=>`
...
function renderAbout(){ $("page-about").innerHTML = `<div class="pageTitle"><div><h1>About</h1><div class="hint">System information and credits.</div></div></div><div class="panel aboutBox"><h2>SJTC Production Department Dashboard</h2><p>A production and logistics coordination system for monitoring projects, tracking item-level production progress, managing partial delivery batches, and coordinating logistics requests.</p><p><b>Version:</b> 1.2.7<br><b>Company:</b> SJTC Manufacturing Inc. / Focolare Carpentry</p><p><b>Developed by:</b> Engr. CK Empeynado</p><p class="small">This system uses GitHub Pages for the frontend, Cloudflare Worker as proxy, Google Apps Script as API, and Google Sheets as database. It is intended for internal production monitoring and logistics coordination.</p></div>`; }
